...
To run TuxNet, navigate to the folder you chose for TuxNet to be installed in and execute 'sudo ./run_TuxNet.sh <mcr_directory>' where <mcr_directory> is the location where MATLAB Runtime is installed. For example: 'sudo ./run_TuxNet.sh /home/user/username/MATLAB_Runtime/v96'. You will be prompted to choose the current working directory via a file finder: '<TuxNetLocation>/application' should be your selection.
